...
export IMAGE_NAME="psp-deployment"
export BASE_DIR=$(pwd)
export GCP_PROJECT="ac215-mushroom" # Change to your GCP Project
...
--mount type=bind,source=$BASE_DIR/../psp-api-service,target=/psp-api-service \
